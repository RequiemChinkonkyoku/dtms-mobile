        ...
        <ScrollView style={styles.container}>
            ...
            <View style={styles.contentContainer}>
                <View style={styles.headerContainer}>
                    ...
                    <View style={[
                        styles.statusBadge,
                        document.status === 1 ? styles.statusBadgeActive : styles.statusBadgeInactive
                    ]}>
                        <Text style={[
                            styles.statusText,
                            document.status === 1 ? styles.statusTextActive : styles.statusTextInactive
                        ]}>
